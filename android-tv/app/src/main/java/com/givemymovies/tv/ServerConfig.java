...
final class ServerConfig {
    ...
    static ServerConfig load(Context context) {
        ...
        return new ServerConfig(prefs.getString("base_url", BuildConfig.DEFAULT_SERVER_URL.isEmpty() ? "http://100.64.0.1:7399" : BuildConfig.DEFAULT_SERVER_URL),
                prefs.getString("key", BuildConfig.DEFAULT_SERVER_KEY), prefs.getBoolean("jellyfin_fallback", false));
    }
